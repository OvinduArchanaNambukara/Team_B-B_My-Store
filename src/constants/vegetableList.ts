...
export const vegetableList: IProduct[] = [
  {
    product: {id: "0001", name: "Carrot", image: CarrotImg, currentPrice: 75, oldPrice: 85, qty: "Kg"},
    inCart: false
  }, {
    product: {id: "0002", name: "Cabbage", image: CabbageImg, currentPrice: 35, oldPrice: null, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0003", name: "Garlic", image: GarlicImg, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0004", name: "Leaks", image: LeaksImg, currentPrice: 35, oldPrice: null, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0005", name: "Onion", image: OnionImg, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0006", name: "Potato", image: PotatoImg, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0007", name: "Egg Plant", image: EggplantImg, currentPrice: 75, oldPrice: 85, qty: "Kg"},
    inCart: false
  },
];
