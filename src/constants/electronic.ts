...
export const electronicList: IProduct[] = [
  {
    product: {id: "0501", name: "Blender", image: Blender, currentPrice: 75, oldPrice: 85, qty: "Kg"},
    inCart: false
  }, {
    product: {id: "0502", name: "Coffee-Maker", image: CofeeMaker, currentPrice: 35, oldPrice: null, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0503", name: "Iron", image: iron, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0504", name: "Note 10+", image: mobile, currentPrice: 35, oldPrice: null, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0505", name: "Mac Book", image: macbook, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  }, {
    product: {id: "0506", name: "Microwave", image: microwave, currentPrice: 35, oldPrice: null, qty: "Kg"},
    inCart: false
  },
  {
    product: {id: "0507", name: "Refrigerators", image: refregirator, currentPrice: 35, oldPrice: 45, qty: "Kg"},
    inCart: false
  },
];
